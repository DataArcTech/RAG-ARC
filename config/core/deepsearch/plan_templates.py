...
PLAN_TEMPLATES: List[Dict[str, Any]] = [
    {
        ...
        "description": (
            "Use file routing + in-file navigation (toc/tree/locate with file) to find the right pages, "
        ...
        "plan_items": [
            ...
            "Within the selected file, navigate sections via toc.tree / tree.* and use locate(file=X) to shortlist relevant pages.",
