from core.prompts.deepsearch.plan import GRAPH_PLANNER_SYSTEM_PROMPT, GRAPH_PLANNER_USER_PROMPT


def test_graph_planner_prompt_mentions_error_taxonomy_and_evidence_rules() -> None:
    prompt = GRAPH_PLANNER_SYSTEM_PROMPT
...
def test_graph_planner_user_prompt_mentions_empty_hit_stop_loss() -> None:
    prompt = GRAPH_PLANNER_USER_PROMPT
