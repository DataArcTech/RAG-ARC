...
class ParserCombinator(AbstractModule):
    ...
    def __init__(self, config: "ParserCombinatorConfig"):
        ...
        base_output_dir_token = str(base_output_dir).strip()
        self.base_output_dir = base_output_dir_token
        self._base_output_is_io = self.base_output_dir.startswith("io://")
        ...
        if ocr_parser_config is not None:
            ...
            if self._base_output_is_io:
                resolved_output_dir = f"{self.base_output_dir.rstrip('/')}/{ocr_subdir}"
            else:
                resolved_output_dir = str((Path(self.base_output_dir) / ocr_subdir))
        ...
        if native_parser_config is not None:
            ...
            if self._base_output_is_io:
                ...
                resolved_output_dir = str((Path(self.base_output_dir) / native_subdir))
