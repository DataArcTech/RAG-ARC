...
THINK_TOOL_SYSTEM_PROMPT = (
    ...
    "- If a probe/scan returned no usable hits, do NOT get stuck: propose parallel tool calls such as (1) widen cheap tool parameters (e.g., raise top_k / max_terms / broaden match_fields) and (2) try a different tool from the available_tools catalog.\n"
