...
RUN_DIR="local/e2e/concurrency_runner_${RUN_ID}"
mkdir -p "$RUN_DIR"

E2E_POSTGRES_DB="${E2E_POSTGRES_DB:-rag_arc_conc_${RUN_ID}}"
E2E_REDIS_DB="${E2E_REDIS_DB:-14}"
...
echo "Concurrency run dir: $RUN_DIR"
...
echo "Concurrency probe completed successfully."
echo "Logs:"
echo "  - $RUN_DIR/concurrency.log"
echo "  - $RUN_DIR/uvicorn.log"
